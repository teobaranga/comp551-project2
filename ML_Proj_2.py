...
train_x = pd.read_csv('dat_train_x_no_eng.csv', encoding = 'utf-8') # Read csv training file x data
train_y = pd.read_csv('dat_train_y_no_eng.csv') # Read csv training file y data

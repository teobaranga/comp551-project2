...
train_x = pd.read_csv('train_set_x.csv', encoding = 'utf-8') # Read csv training file x data
train_y = pd.read_csv('train_set_y.csv') # Read csv training file y data
...
train_x.to_csv('train_x_no_eng.csv', encoding = 'utf-8') # Write new csv file
train_y.to_csv('train_y_no_eng.csv')